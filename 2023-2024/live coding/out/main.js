...
const sumOftwoNumbersAsLambda = (a) => {
    const internalfunc = b => a + b;
    return internalfunc;
};
//onjuiste manier
...
function sumOfAllNumbersRec_v0(n) {
    let sum = 0;
    while (n > 0) {
        //sum += n--
        sum = sum + n;
...
function sumOfAllNumbersRec(n) {
    return n === 0 ? n : n + sumOfAllNumbersRec(n - 1);
}
const sumOfAllNumbersRec_v2 = n => n === 0 ? n : n + sumOfAllNumbersRec_v2(n - 1);
console.log;
